    ...
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-20 mx-auto">
          ...
          <div class="grid grid-cols-2 lg:grid-cols-3 sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6 gap-5">
            <div class="p-4 shadow flex">
              ...
              <div class="flex-grow pl-6">
                <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Free Shipping & Return</h2>
            ...
            <div class="p-4 shadow flex">
              ...
              <div class="flex-grow pl-6">
                <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Customer Support 24/7</h2>
                <p class="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy.</p>
            ...
            <div class="p-4 shadow flex">
              ...
              <div class="flex-grow pl-6">
                <h2 class="text-gray-900 text-lg title-font font-medium mb-2">100% Secure Payment</h2>
                <p class="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy.</p>
        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full shadow bg-gray-100 p-8 rounded">
                ...
                <a className="inline-flex items-center">
                  ...
                  <span className="flex-grow flex flex-col pl-4">
                    <span className="title-font font-medium text-gray-900">Akash Singh</span>
            ...
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full shadow bg-gray-100 p-8 rounded">
                ...
                <a className="inline-flex items-center">
                  ...
                  <span className="flex-grow flex flex-col pl-4">
                    <span className="title-font font-medium text-gray-900">Badal Kumar</span>
                    <span className="text-gray-500 text-sm">CUSTOMER</span>
                  </span>
                </a>
              </div>
